...
static struct clkctl_acpu_speed acpu_freq_tbl_anthrax[] = {
  ...
  { {1, 1}, 1536000,  ACPU_SCPLL, 0, 0, 1, 0x1D, L2(21), 1250000, 0x03006000},
  { {1, 1}, 1566000,  ACPU_SCPLL, 0, 0, 1, 0x1E, L2(22), 1250000, 0x03006000},
  { {1, 1}, 1620000,  ACPU_SCPLL, 0, 0, 1, 0x1F, L2(22), 1250000, 0x03006000},
  { {1, 1}, 1674000,  ACPU_SCPLL, 0, 0, 1, 0x20, L2(22), 1300000, 0x03006000},
  { {1, 1}, 1728000,  ACPU_SCPLL, 0, 0, 1, 0x21, L2(22), 1350000, 0x03006000},
  { {0, 0}, 0 },
};
